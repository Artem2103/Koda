...
export const CLIENT_LOGOS = [
  "Maersk", "DHL", "Kuehne+Nagel", "DB Schenker", "Cargill",
...
// ─── TEAM ─────────────────────────────────────────────────────────────────────
export const TEAM = [
  { name: "Artem Lyutyi",    role: "CEO & Co-founder",        bio: "Former Head of Freight at Maersk. 14 years routing complex international cargo across sanctioned and conflict zones." },
  ...
  { name: "Nina Lyuta",      role: "Head of Logistics AI",    bio: "PhD in operations research. Designed route optimisation algorithms now used by three of the world's top-10 shipping lines." },
  ...
  { name: "Arina Lyuta",  role: "Head of Systems",         bio: "Built trade finance analytics at HSBC. Specialises in landed-cost modelling across emerging market corridors." },
];
...
export const OFFICES = [
  { city: "Rotterdam",   address: "Wilhelminakade 123, 3072 AP",  tz: "GMT+1" },
